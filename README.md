...
java_exercices/
│
├── basico/            # Variáveis, entrada/saída, operações matemáticas...
├── condicionais/            # If, else if, else, operadores lógicos...
├── loops/            # For, while, do-while, tabuada, contadores, repetições...
├── arrays/            # Vetores, matrizes, médias, maior/menor valor...
├── funcoes/            # Métodos com retorno, parâmetros...
└── poo/            # Classes, objetos, atributos, métodos, encapsulamento, construtores...
```
